      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <h3 className="font-serif text-3xl font-bold bg-linear-to-r from-background to-background/80 bg-clip-text text-transparent">
              The Myriad
            </h3>
            ...
            <div className="space-y-3 pt-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:Support@myriad.net.in" className="text-background/70 hover:text-background text-sm transition-colors">
            ...
            <ul className="space-y-3">
              <li>
                <button 
                  ...
                  className="text-background/70 hover:text-background text-sm flex items-center gap-2 group transition-all duration-200 w-full text-left"
                >
                  <ArrowRight className="w-3 h-3 opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all" />
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              >
                <div className="w-8 h-8 rounded-full bg-background/20 group-hover:bg-background/30 flex items-center justify-center shrink-0">
